...
/**
 * The <code>TestRemote</code> class provides a Java RMI-compliant interface to the 
 ...
 * generate RMI server proxy objects for instances of Untitled3.Test.
 */
public interface TestRemote extends Poolable
{
    /**
     * Provides the standard interface for calling the <code>abs</code> M-function with 0 
     * input argument.  
     *
     ...
     */
    public Object[] abs(Object... rhs) throws RemoteException;
    /**
     * Provides the standard interface for calling the <code>conv2</code> M-function with 
     * 0 input argument.  
     *
     * Input arguments to standard interface methods may be passed as sub-classes of 
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of any 
     ...
     * in communication with the server.
     */
    public Object[] conv2(Object... rhs) throws RemoteException;
