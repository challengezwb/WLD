...
public class test extends MWComponentInstance<test>
{
    ...
    {
        this(Test1MCRFactory.newInstance());
    }
    ...
    {
        this(Test1MCRFactory.newInstance(getPathToComponentOptions(pathToComponent)));
    }
    ...
    {
        this(Test1MCRFactory.newInstance(componentOptions));
    }
    ...
    {
        try {
            MWMCR mcr = Test1MCRFactory.newInstance();
